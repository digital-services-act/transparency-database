...
class EuropeanCountriesServiceTest extends TestCase
{
    ...
    public function test_it_gets_all_the_options(): void
    {
    ...
    public function test_it_condenses_european_union_countries(): void
    {
    ...
    public function test_it_condenses_countries_uniquely(): void
    {
    ...
    public function test_it_condenses_european_economic_area_countries(): void
    {
    ...
    public function test_it_does_not_condense_european_union_countries(): void
    {
        $country_codes = EuropeanCountriesService::EUROPEAN_UNION_COUNTRY_CODES;
    ...
    public function test_it_filters_out_non_european_countries(): void
    {
        $country_codes = EuropeanCountriesService::EUROPEAN_UNION_COUNTRY_CODES;
        $country_codes[] = 'US';
        $country_codes[] = 'CA';
    ...
    public function test_it_does_not_break_on_empty(): void
    {
        $country_codes = [];
        $result = $this->european_countries_service->filterSortEuropeanCountries($country_codes);
    ...
    public function test_ensure_that_country_codes_arrays_are_in_alphabetical_order(): void
    {
     ...
     */
    public function test_the_char_length_is_ok(): void
    {
        $max = 255;
    ...
    public function test_it_throws_an_error_and_returns_false(): void
    {
        $test_iso = 'xx';
    ...
    public function test_it_returns_nothing_on_nothing(): void
    {
        $test_countries = [];
