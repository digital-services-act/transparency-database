...
export const generateStatementRequestBody = (data, overrides = {}) => ({
  ...
  decision_visibility: [_.sample(data.decision_visibility)],
  ...
  content_type: [..._.sampleSize(data.content_type, _.sample([1, 2, 3]))],
  category: _.sample(data.categories),
  category_specification: _.sampleSize(
    data.category_specification,
    _.sample([1, 2, 3, 4]),
  ),
  territorial_scope: [
  ...
  end_date_monetary_restriction: faker.date
    .recent()
    .toISOString()
    .split("T")[0],
