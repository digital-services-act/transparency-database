...
class StatementFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'id' => $id,
            'decision_visibility' => $this->faker->randomElements(array_keys(Statement::DECISION_VISIBILITIES), 2,
                false),
            ...
            'territorial_scope' => $this->faker->randomElements(EuropeanCountriesService::EUROPEAN_COUNTRY_CODES, 2,
                false),
