...
**Statement of Reasons (SoR)**: Each SoR will be accessible via the [Search Statement of Reasons](/statement) page for a period of six months (180 days) from the date it is entered into the Transparency Database. After six months, the SoR will be removed from the search index but will remain accessible in the CSV format within the [daily dumps files](/explore-data/download). Since the implementation of our V.2 Schema on July 1st, we have archived any previous SORs from V1 of the Transparency Database. From July 1st, only SORs with our newly implemented V2 (which contains more categories for SORs) will be available to view, once submitted. The SoR will continue to contribute to the dataset presented in the [Dashboard](/dashboard).
