...
@section('content')
    ...
    <p class="ecl-u-type-paragraph">
        <strong>Legal Disclaimer</strong>: As established under Article 24(5) of Regulation (EU) 2022/2065 on a Single
    ...
    <p class="ecl-u-type-paragraph">
        <strong>Personal data</strong>: In accordance with Article 24(5) DSA, this database shall not contain personal
        data. It is the obligation of the providers of online platforms to ensure that the information that they submit
        does not contain any personal data.
    </p>

    <p class="ecl-u-type-paragraph">
        <strong>Report an issue</strong>: It is possible to report problems with individual statements of reasons in
        this database, using a dedicated button located at the bottom of the page. This functionality can be used, for
        example, if a statement of reasons contains personal information despite the fact that providers of online platforms must ensure that all personal data is redacted before the submission into the database.
    </p>

    <p class="ecl-u-type-paragraph">
        <strong>Information on possibilities for redress</strong>:  Article 17(3)(f) DSA requires providers of hosting
    ...
    <p class="ecl-u-type-paragraph">
        <strong>Affected online platforms</strong>: Designated very large online platforms need to comply with the DSA
