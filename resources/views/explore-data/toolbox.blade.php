    ...
    <div class="ecl-row ecl-u-mt-l">
        ...
        <p class="ecl-u-type-paragraph">
            <ul class="ecl-unordered-list ecl-unordered-list--no-bullet ecl-u-mb-l">
                        ...
                        <li class="ecl-unordered-list__item">Easily download the daily download files, perform their checksum verification and convert them into
                            data processing-ready csv or parquet files.
                        </li>

                        <li class="ecl-unordered-list__item">Filter and/or aggregate the statements of reasons across user-selected variables from the database
                            schema to create bespoke datasets for advanced visualisations or to answer advanced research
                            questions.
                        </li>

                        <li class="ecl-unordered-list__item">Develop ad-hoc dashboards and visualisations based on the aggregated data using the Apache Superset
                            framework.
                        </li>
                    </ul>
        </p>
        ...
        <p class="ecl-u-type-paragraph">
            ...
            <ul class="ecl-unordered-list ecl-u-mb-l">
                        ...
                        <li class="ecl-unordered-list__item">through a jupyter notebook, directly using the module’s python bindings;</li>
                        <li class="ecl-unordered-list__item">through fully functional APIs, either programmatically or using an interactive web-based
                            interface.
                        </li>
                    </ul>
        </p>
        <p class="ecl-u-type-paragraph">
            To access the package as well as its full technical documentation, you can visit the <a href="https://code.europa.eu/dsa/transparency-database/dsa-tdb">dsa-tdb page on
            code.europa.eu</a>.
        </p>
        <p class="ecl-u-type-paragraph">
