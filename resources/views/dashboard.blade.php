...
@section('content')
    ...
    <p class="ecl-u-type-paragraph" style="max-width:none !important">
        The dashboard below provides a user-friendly and interactive interface to explore summarized data. Start exploring
        the data by clicking on different elements. Via the <strong>menu</strong>, on the top left of the dashboard, you can
        set filters.
        <br /><br />
    ...
    <div style="width:110%; !important;
        ...
        <div class="ecl-u-d-flex">
            ...
            <div
                ...
                <div class="ecl-u-type-paragraph ecl-u-type-s ecl-u-mb-s">Note that highlights apply only to the page in
                    which they are triggered. For filters that apply to all the pages, use the ‘filters’ menu on the top
                    left – see below.
                </div>
                ...
                <div class="ecl-u-type-paragraph ecl-u-type-s ecl-u-mb-s">To close the filters menu, click on the ‘back’
                ...
                <div class="ecl-u-type-paragraph ecl-u-type-s ecl-u-mb-s">Please refer to the <a
                        href="https://digital-strategy.ec.europa.eu/en/faqs/dsa-transparency-database-questions-and-answers">FAQ
                        section</a> about the filters that are available.
                </div>
                ...
                <div class="ecl-u-type-paragraph ecl-u-type-s ecl-u-mb-s">This way, you can, for example, select all the
            ...
            <div
                ...
                <div class="ecl-u-type-paragraph ecl-u-type-s ecl-u-mb-s"> By default, the dashboard considers your
                    browser’s settings for the format of displaying dates. Therefore, you may see dates as MM/DD/YYYY,
