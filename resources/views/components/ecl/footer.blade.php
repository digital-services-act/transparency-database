<footer class="ecl-site-footer">
    <div class="ecl-container ecl-site-footer__container">
        <div class="ecl-site-footer__row">
            <div class="ecl-site-footer__column">
                <div class="ecl-site-footer__section">
                    <h2 class="ecl-site-footer__title"><a href="{{route('home')}}"
                                                          class="ecl-link ecl-link--standalone ecl-site-footer__title-link">DSA Transparency Database</a></h2>
            ...
            <div class="ecl-site-footer__column">
                <div class="ecl-site-footer__section">
                    ...
                    <ul class="ecl-site-footer__list">
                        <li class="ecl-site-footer__list-item"><a href="/component-library/example"
                    ...
                    <ul class="ecl-site-footer__list ecl-site-footer__list--inline">
                        <li class="ecl-site-footer__list-item"><a href="/component-library/example"
                                                                  ...
                                                                  aria-label="Link to Facebook"><svg class="ecl-icon ecl-icon--xs ecl-link__icon" focusable="false"
                                                                                                     aria-hidden="true">
                                    <use xlink:href="{{asset('static/media/icons-social-media.50ee4d61.svg#facebook-negative')}}">
                                    </use>
                        ...
                        <li class="ecl-site-footer__list-item"><a href="/component-library/example"
                                                                  ...
                                                                  aria-label="Link to Twitter"><svg class="ecl-icon ecl-icon--xs ecl-link__icon" focusable="false"
                                                                                                    aria-hidden="true">
                                    <use xlink:href="{{asset('static/media/icons-social-media.50ee4d61.svg#twitter-negative')}}">
                                    </use>
                        ...
                        <li class="ecl-site-footer__list-item"><a href="/component-library/example"
                                                                  ...
                                                                  aria-label="Link to Linkedin"><svg class="ecl-icon ecl-icon--xs ecl-link__icon" focusable="false"
                                                                                                     aria-hidden="true">
                                    <use xlink:href="{{asset('static/media/icons-social-media.50ee4d61.svg#linkedin-negative')}}">
                                    </use>
        ...
        <div class="ecl-site-footer__row">
            <div class="ecl-site-footer__column">
                <div class="ecl-site-footer__section"><a href="/component-library/example"
                    ...
                    <h2 class="ecl-site-footer__title"><a href="https://commission.europa.eu/index_en"
            ...
            <div class="ecl-site-footer__column">
                <div class="ecl-site-footer__section ecl-footer-standardised__section--split-list">
                    <ul class="ecl-site-footer__list">
                        <li class="ecl-site-footer__list-item"><a href="https://commission.europa.eu/language-policy_en"
                                                                  class="ecl-link ecl-link--standalone ecl-site-footer__link"
