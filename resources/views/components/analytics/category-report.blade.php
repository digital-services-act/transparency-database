...
<div class="ecl-fact-figures ecl-fact-figures--col-3">
    <div class="ecl-fact-figures__items">
        ...
        <div class="ecl-fact-figures__item">
            ...
            <div class="ecl-fact-figures__value">{{ $category_report['category_total'] }} statements</div>
        ...
        <div class="ecl-fact-figures__item">
            ...
            <div class="ecl-fact-figures__value">{{ $category_report['category_last_days_ago'] }} statements</div>
        ...
        <div class="ecl-fact-figures__item">
            ...
            <div class="ecl-fact-figures__value">{{ $category_report['category_last_months_ago'] }} statements</div>
