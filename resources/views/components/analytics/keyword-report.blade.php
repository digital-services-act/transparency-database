...
<div class="ecl-fact-figures ecl-fact-figures--col-3">
    <div class="ecl-fact-figures__items">
        ...
        <div class="ecl-fact-figures__item">
            ...
            <div class="ecl-fact-figures__value">@aif($keyword_report['keyword_total']) statements of reasons</div>
        ...
        <div class="ecl-fact-figures__item">
            ...
            <div class="ecl-fact-figures__value">@aif($keyword_report['keyword_last_days_ago']) statements of reasons</div>
        ...
        <div class="ecl-fact-figures__item">
            ...
            <div class="ecl-fact-figures__value">@aif($keyword_report['keyword_last_months_ago']) statements of reasons</div>
...
<h2 class="ecl-u-type-heading-2">Created for the Last @aif(count($keyword_report['day_totals_values'])) Days</h2>
...
<h2 class="ecl-u-type-heading-2">Created for the Last @aif(count($keyword_report['month_totals_values'])) {{Str::of('Month')->plural(count($keyword_report['month_totals_values']))}}</h2>
