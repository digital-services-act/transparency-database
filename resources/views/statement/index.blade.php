...
@section('content')
    ...
    <div class="ecl-row ecl-u-mt-l ecl-u-mb-xl">
        <div class="ecl-col-l-12">
            ...
            <div class="ecl-u-type-paragraph ecl-u-mb-l" style="max-width:none !important">
            ...
            <x-ecl.expandable label="How Search works">
                <p class="ecl-u-type-paragraph">
                    ...
                    statement of
                    reasons.
                    Searching for the platform name in the free-text search only returns statements of reasons which
                    contain
                    the
                    platform
                    name entered in one of their free-text fields. To search for statements of reasons submitted by a
                    specific
                    online
                    platform, please use the “Platform” dropdown selector to select one or more platforms of interest
                    instead.<br />
                    <br />
                    To filter statements of reasons by (a combination of) other variables, in addition to the platform
                    they
                    were
                    submitted
