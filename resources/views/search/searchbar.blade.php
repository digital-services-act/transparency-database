<div class="ecl-site-header__search-container">
    ...
    <form class="ecl-search-form ecl-site-header__search" role="search" data-ecl-search-form="" id="search-form-id" action="{{route('search')}}" method="get">
        @csrf
        <div class="ecl-form-group">
            <label for="search-input-id" class="ecl-form-label ecl-search-form__label">Search</label>
            <input type="search" id="search-input-id" name="query" class="ecl-text-input ecl-text-input--m ecl-search-form__text-input" placeholder="Search for a statement or entity"/>
        </div>
