...
@section('content')
    ...
    <h2 class="ecl-u-type-heading-2">Visibility Restrictions for the Last {{ $last_days }} Days</h2>
    ...
    <h2 class="ecl-u-type-heading-2">Monetary Restrictions for the Last {{ $last_days }} Days</h2>
    ...
    <h2 class="ecl-u-type-heading-2">Provision Restrictions for the Last {{ $last_days }} Days</h2>
    ...
    <h2 class="ecl-u-type-heading-2">Account Restrictions for the Last {{ $last_days }} Days</h2>
