...
@section('content')
    ...
    <div class="ecl-fact-figures ecl-fact-figures--col-3">
        <div class="ecl-fact-figures__items">
            ...
            <div class="ecl-fact-figures__item">
                ...
                <div class="ecl-fact-figures__value">@aif($total_last_days)</div>
                <div class="ecl-fact-figures__title">Statements of reasons last @aif($last_days) Days</div>
            </div>
            ...
            <div class="ecl-fact-figures__item">
                ...
                <div class="ecl-fact-figures__value">@aif($total_last_months)</div>
                <div class="ecl-fact-figures__title">Statements of reasons last @aif($last_months) months</div>
            </div>
            ...
            <div class="ecl-fact-figures__item">
                ...
                <div class="ecl-fact-figures__value">@aif($average_per_hour)</div>
            ...
            <div class="ecl-fact-figures__item">
                ...
                <div class="ecl-fact-figures__value">@aif($platforms_total) platforms</div>
            ...
            <div class="ecl-fact-figures__item">
                ...
                <div class="ecl-fact-figures__value">@aif($average_per_hour_per_platform)</div>
    ...
    <h2 class="ecl-u-type-heading-2">Statements of reasons over @aif(count($day_totals_values)) days</h2>
