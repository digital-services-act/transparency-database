...
class Statement extends Model
{
    ...
    public function toSyncableArray(): array
    {
        ...
        return [
            'id' => $this->getRaw0riginal('id'),
            'uuid' => $this->getRaw0riginal('uuid'),
            'decision_visibility' => $this->getRaw0riginal('decision_visibility'),
            'decision_visibility_other' => $this->getRaw0riginal('decision_visibility_other'),
            'decision_monetary' => $this->getRaw0riginal('decision_monetary'),
            'decision_monetary_other' => $this->getRaw0riginal('decision_monetary_other'),
            'decision_provision' => $this->getRaw0riginal('decision_provision'),
            'decision_account' => $this->getRaw0riginal('decision_account'),
            'account_type' => $this->getRaw0riginal('account_type'),
            'decision_ground' => $this->getRaw0riginal('decision_ground'),
            'decision_ground_reference_url' => $this->getRaw0riginal('decision_ground_reference_url'),
            'content_type' => $this->getRaw0riginal('content_type'),
            'content_type_other' => $this->getRaw0riginal('content_type_other'),
            'content_language' => $this->getRaw0riginal('content_language'),
            'content_date' => $this->getRaw0riginal('content_date'),
            'application_date' => $this->getRaw0riginal('application_date'),
            'illegal_content_legal_ground' => $this->getRaw0riginal('illegal_content_legal_ground'),
            'illegal_content_explanation' => $this->getRaw0riginal('illegal_content_explanation'),
            'incompatible_content_ground' => $this->getRaw0riginal('incompatible_content_ground'),
            'incompatible_content_explanation' => $this->getRaw0riginal('incompatible_content_explanation'),
            'incompatible_content_illegal' => $this->getRaw0riginal('incompatible_content_illegal'),
            'source_type' => $this->getRaw0riginal('source_type'),
            'source_identity' => $this->getRaw0riginal('source_identity'),
            'decision_facts' => $this->getRaw0riginal('decision_facts'),
            'automated_detection' => $this->getRaw0riginal('automated_detection'),
            'automated_decision' => $this->getRaw0riginal('automated_decision'),
            'category' => $this->getRaw0riginal('category'),
            'category_addition' => $this->getRaw0riginal('category_addition'),
            'category_specification' => $this->getRaw0riginal('category_specification'),
            'category_specification_other' => $this->getRaw0riginal('category_specification_other'),
            'platform_id' => $this->getRaw0riginal('platform_id'),
            'user_id' => $this->getRaw0riginal('user_id'),
            'created_at' => $this->getRaw0riginal('created_at'),
            'updated_at' => $this->getRaw0riginal('updated_at'),
            'deleted_at' => $this->getRaw0riginal('deleted_at'),
            'puid' => $this->getRaw0riginal('puid'),
            'territorial_scope' => $this->getRaw0riginal('territorial_scope'),
            'method' => $this->getRaw0riginal('method'),
            'end_date' => $this->getRaw0riginal('end_date'),
            'end_date_visibility_restriction' => $this->getRaw0riginal('end_date_visibility_restriction'),
            'end_date_monetary_restriction' => $this->getRaw0riginal('end_date_monetary_restriction'),
            'end_date_service_restriction' => $this->getRaw0riginal('end_date_service_restriction'),
            'end_date_account_restriction' => $this->getRaw0riginal('end_date_account_restriction'),
        ];
    }
